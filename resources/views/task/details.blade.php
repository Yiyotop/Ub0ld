            ...
            <div class="col-xl-8 col-lg-7">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="d-flex align-items-start">
                                    <img src="{{ Vite::asset('resources/images/users/user-9.jpg') }}" alt="Arya S" class="rounded-circle me-2" height="24" />
                                    <div class="w-100">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start">
                            <img class="me-2 rounded-circle" src="{{ Vite::asset('resources/images/users/user-3.jpg') }}" alt="Generic placeholder image" height="32" />
                            <div class="w-100">
                                ...
                                <div class="d-flex align-items-start mt-3">
                                    <a class="pe-2" href="#">
                                        <img src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" class="rounded-circle" alt="Generic placeholder image" height="32" />
                                    </a>
                                    <div class="w-100">
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-2 rounded-circle" src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" alt="Generic placeholder image" height="32" />
                            <div class="w-100">
