                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-nowrap mb-0">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 90px;">
                                                        <img src="{{ Vite::asset('resources/images/products/product-1.png') }}" alt="product-img" title="product-img" class="rounded" height="48" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{ Vite::asset('resources/images/products/product-2.png') }}" alt="product-img" title="product-img" class="rounded" height="48" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{ Vite::asset('resources/images/products/product-3.png') }}" alt="product-img" title="product-img" class="rounded me-2" height="48" />
                                                    </td>
                                                    <td>
