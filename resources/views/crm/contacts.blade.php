                        ...
                        <div class="table-responsive">
                            <table class="table table-centered table-nowrap table-hover mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="table-user">
                                            <img src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" alt="table-user" class="me-2 rounded-circle">
                                    ...
                                    <tr>
                                        <td class="table-user">
                                            <img src="{{ Vite::asset('resources/images/users/user-3.jpg') }}" alt="table-user" class="me-2 rounded-circle">
                                    ...
                                    <tr>
                                        <td class="table-user">
                                            <img src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" alt="table-user" class="me-2 rounded-circle">
                                    ...
                                    <tr>
                                        <td class="table-user">
                                            <img src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" alt="table-user" class="me-2 rounded-circle">
                                    ...
                                    <tr>
                                        <td class="table-user">
                                            <img src="{{ Vite::asset('resources/images/users/user-6.jpg') }}" alt="table-user" class="me-2 rounded-circle">
                                    ...
                                    <tr>
                                        <td class="table-user">
                                            <img src="{{ Vite::asset('resources/images/users/user-7.jpg') }}" alt="table-user" class="me-2 rounded-circle">
                                    ...
                                    <tr>
                                        <td class="table-user">
                                            <img src="{{ Vite::asset('resources/images/users/user-8.jpg') }}" alt="table-user" class="me-2 rounded-circle">
                                    ...
                                    <tr>
                                        <td class="table-user">
                                            <img src="{{ Vite::asset('resources/images/users/user-9.jpg') }}" alt="table-user" class="me-2 rounded-circle">
                                    ...
                                    <tr>
                                        <td class="table-user">
                                            <img src="{{ Vite::asset('resources/images/users/user-10.jpg') }}" alt="table-user" class="me-2 rounded-circle">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start mb-3">
                            <img class="d-flex me-3 rounded-circle avatar-lg" src="{{ Vite::asset('resources/images/users/user-8.jpg') }}" alt="Generic placeholder image">
                            <div class="w-100">
